  ...
  static const _babyArticles = <String, List<Map<String, String>>>{
    'صحة الطفل العامة': [
      {'title': 'الحمى عند الرضع: متى تقلقين', 'image': 'https://images.unsplash.com/photo-1519689680058-324335c77eba?w=600&q=80',
       'content': 'الحمى هي استجابة طبيعية من جهاز المناعة لدى الرضيع لمكافحة العدوى وهي ليست مرضاً بحد ذاتها بل عرض يدل على أن الجسم يقاوم شيئاً ما. تُعتبر درجة حرارة ثمانية وثلاثين درجة مئوية أو أكثر حمى عند الرضيع عند قياسها من تحت الإبط وثمانية وثلاثين ونصف من الشرج.  استخدمي ميزان حرارة رقمي دقيق وقيسي الحرارة من تحت الإبط لمدة ثلاث دقائق أو من الأذن باستخدام ميزان أذن مخصص. تجنبي الموازين الزئبقية القديمة وشرائط الجبهة لأنها أقل دقة. قيسي الحرارة مرتين يومياً على الأقل وسجلي القراءات مع الوقت.  للعناية بالرضيع المحموم ألبسيه ملابس قطنية خفيفة لا تكثري من التغطية حتى لو شعر بالبرد. قدمي السوائل بكثرة سواء حليب الأم أو الماء للأطفال فوق ستة أشهر لمنع الجفاف. استخدمي كمادات فاترة وليست باردة على الجبهة والرقبة واليدين. يمكنك إعطاء الباراسيتامول المخصص للرضع حسب وزن الطفل وعمره بعد استشارة الطبيب ولا تعطي الإيبوبروفين للأطفال أقل من ستة أشهر ولا تستخدمي الأسبرين أبداً للأطفال.  اتصلي بالطبيب فوراً إذا كان عمر الطفل أقل من ثلاثة أشهر وحرارته مرتفعة أو إذا استمرت الحمى أكثر من ثلاثة أيام أو تجاوزت أربعين درجة أو رافقتها أعراض مقلقة كالطفح الجلدي أو صعوبة التنفس أو الخمول الشديد أو القيء المستمر أو رفض الرضاعة أو بكاء غير معتاد أو انتفاخ اليافوخ. في حالات نادرة قد تسبب الحمى العالية تشنجات حرارية وهي مخيفة لكنها غالباً غير خطيرة. حافظي على هدوئك وضعي الطفل على جنبه واتصلي بالإسعاف.'},
      {'title': 'العناية ببشرة الطفل الحساسة', 'image': 'https://images.unsplash.com/photo-1544126592-807ade215a0b?w=600&q=80',
       'content': 'بشرة الرضيع رقيقة وحساسة للغاية وأرق بعشرين إلى ثلاثين بالمئة من بشرة البالغين مما يجعلها أكثر عرضة للجفاف والتهيج والعدوى. تحتاج هذه البشرة الناعمة إلى عناية خاصة ولطيفة باستخدام منتجات مخصصة للأطفال خالية من العطور والمواد الكيميائية القاسية والأصباغ والكحول.  الحمام يجب أن يكون لطيفاً ومرتين إلى ثلاث مرات أسبوعياً فقط في الأشهر الأولى لأن الاستحمام اليومي يزيل الزيوت الطبيعية ويسبب الجفاف. استخدمي ماء فاتر بدرجة حرارة سبعة وثلاثين درجة تقريباً وغسول خفيف بدون صابون. لا تتركي الطفل في الماء أكثر من عشر دقائق. جففي بشرته بلطف بالتربيت وليس الفرك.  رطبي بشرة طفلك بعد كل حمام بكريم أو لوشن مرطب لطيف خاصة في فصل الشتاء عندما يكون الهواء جافاً. الإكزيما شائعة عند الرضع وتظهر كبقع حمراء متقشرة ومثيرة للحكة على الوجه والمرفقين والركبتين. استخدمي مرطباً كثيفاً عدة مرات يومياً واستشيري طبيب الأطفال لوصف كريم كورتيزون خفيف إذا لزم الأمر.  تجنبي تعريض بشرة الطفل لأشعة الشمس المباشرة في الأشهر الستة الأولى واستخدمي ملابس قطنية فاتحة اللون تغطي الجسم وقبعة واسعة الحواف. بعد ستة أشهر يمكنك استخدام واقي شمس معدني مخصص للأطفال. اختاري حفاضات ناعمة وغيريها فور اتساخها لمنع التسلخات واستخدمي كريم حاجز يحتوي على أكسيد الزنك عند كل تغيير. اغسلي ملابس الطفل بمنظف خاص خالٍ من العطور واشطفيها مرتين لإزالة أي بقايا مهيجة.'},
    ],
    'تغذية الطفل': [
      {'title': 'الرضاعة الطبيعية: أساس صحة طفلك', 'image': 'https://images.unsplash.com/photo-1609220136736-443140cffec6?w=600&q=80',
       'content': 'تُعد الرضاعة الطبيعية الغذاء الأمثل والأكمل للرضيع في الأشهر الستة الأولى من حياته وتوصي بها منظمة الصحة العالمية حصرياً دون أي إضافات. يحتوي حليب الأم على جميع العناصر الغذائية والأجسام المضادة والإنزيمات والهرمونات التي يحتاجها الطفل للنمو والحماية من الأمراض والعدوى.  ابدئي الرضاعة في الساعة الأولى بعد الولادة للحصول على اللبأ وهو السائل الأصفر الغني بالأجسام المضادة الذي يشكل أول لقاح طبيعي لطفلك. اللبأ يحمي أمعاء المولود ويساعد على تطوير جهازه المناعي ويسهل خروج العقي وهو أول براز للمولود.  أرضعي طفلك عند الطلب دون تحديد جدول صارم في الأسابيع الأولى فهذا يساعد على تثبيت إنتاج الحليب وتلبية احتياجات الطفل المتغيرة. قد يرضع المولود ثماني إلى اثنتي عشرة مرة يومياً في البداية. تأكدي من أن الطفل يمسك بالثدي بشكل صحيح بحيث يشمل فمه الحلمة والهالة كاملة وذقنه يلامس الثدي وشفته السفلى مقلوبة للخارج. الإمساك الصحيح يمنع ألم الحلمة والتشقق ويضمن حصول الطفل على كمية كافية.  كل رضعة تستغرق عادة من عشر إلى عشرين دقيقة من كل ثدي. بدلي الثدي الذي تبدئين به في كل رضعة. اشربي كميات كافية من الماء لا تقل عن ثمانية أكواب يومياً وتناولي غذاء متوازناً غنياً بالبروتين والكالسيوم. الرضاعة تفيد الأم أيضاً فهي تساعد الرحم على الانقباض بعد الولادة وتقلل خطر الإصابة بسرطان الثدي والمبيض وتساعد على خسارة وزن الحمل. لا تقلقي إذا واجهتِ صعوبة في البداية واستشيري استشارية رضاعة معتمدة عند الحاجة.'},
      {'title': 'متى وكيف تبدئين بالأطعمة الصلبة', 'image': 'https://images.unsplash.com/photo-1490818387583-1baba5e638af?w=600&q=80',
       'content': 'يمكن البدء بإدخال الأطعمة التكميلية عند بلوغ الطفل ستة أشهر مع الاستمرار بالرضاعة الطبيعية حتى عمر سنتين أو أكثر. علامات الاستعداد تشمل قدرة الطفل على الجلوس بدعم وإبداء اهتمام بالطعام وفقدان منعكس دفع اللسان الذي يخرج به الطعام من فمه.  ابدئي بالأطعمة المهروسة الناعمة مثل الأرز المسلوق المهروس والبطاطا الحلوة المسلوقة والجزر المسلوق والكوسا والموز المهروس والتفاح المسلوق المهروس. قدمي كمية صغيرة بملعقة ناعمة مخصصة للأطفال. ابدئي بملعقة واحدة إلى ملعقتين وزيدي تدريجياً حسب شهية الطفل.  قاعدة مهمة هي تقديم طعام واحد جديد كل ثلاثة إلى خمسة أيام لمراقبة أي تحسس محتمل. علامات الحساسية تشمل طفح جلدي وإسهال وقيء وتورم الشفتين أو العينين. إذا ظهرت أي من هذه الأعراض أوقفي الطعام الجديد واستشيري الطبيب.  في الشهر السابع أضيفي البروتينات كالدجاج المهروس والعدس المسلوق والبيض المسلوق جيداً والسمك الأبيض المهروس. أضيفي الزبادي الكامل الدسم كمصدر للكالسيوم. في الشهر الثامن قدمي أطعمة مقطعة قطعاً صغيرة ناعمة ليبدأ الطفل بتعلم المضغ واستكشاف القوام المختلف. تجنبي العسل قبل عمر السنة لخطر التسمم الوشيقي والمكسرات الكاملة لخطر الاختناق والملح والسكر المضاف. اجعلي وقت الطعام تجربة ممتعة ومريحة ولا تجبري الطفل على الأكل. قد يحتاج الطفل لتذوق طعام جديد من ثماني إلى خمس عشرة مرة قبل تقبله فتحلي بالصبر.'},
    ],
    'النمو والتطور': [
      {'title': 'مراحل نمو الطفل في السنة الأولى', 'image': 'https://images.unsplash.com/photo-1515488042361-ee00e0ddd4e4?w=600&q=80',
       'content': 'السنة الأولى من حياة طفلك مليئة بالتطورات المذهلة في المهارات الحركية واللغوية والاجتماعية والمعرفية. كل شهر يحمل إنجازات جديدة تستحق المتابعة والتوثيق والاحتفاء.  في الشهر الأول يبدأ المولود بتتبع الأشياء القريبة بعينيه ويستجيب للأصوات العالية ويرفع رأسه لثوانٍ قليلة. في الشهر الثاني يبدأ بالابتسام عند رؤية وجوه مألوفة ويصدر أصوات مناغاة. بحلول الشهر الثالث يرفع رأسه وصدره أثناء الاستلقاء على بطنه ويمسك الأشياء بيده لفترات قصيرة ويبتسم اجتماعياً استجابة للتفاعل.  بين الشهر الرابع والسادس يتعلم الطفل التقلب من بطنه لظهره ثم العكس ويمسك الأشياء ويحملها لفمه ويضحك بصوت عالٍ ويتعرف على اسمه. يبدأ بالجلوس بمساعدة ثم بمفرده ويظهر اهتماماً بالطعام مما يشير لاستعداده للأطعمة التكميلية.  من الشهر السابع إلى التاسع يحبو أو يزحف ويقف مستنداً على الأثاث ويلتقط الأشياء الصغيرة بإبهامه وسبابته ويبدأ بقول مقاطع مثل ماما وبابا وتاتا ويفهم كلمة لا ويلوح بيده. من الشهر العاشر إلى الثاني عشر يمشي مستنداً ثم يخطو خطواته الأولى المستقلة ويقول كلمات بسيطة ويفهم تعليمات بسيطة ويشير لما يريد.  تذكري أن كل طفل يتطور بسرعته الخاصة وهناك مدى طبيعي واسع لكل مهارة. بعض الأطفال يتخطون مرحلة الحبو ويمشون مباشرة وهذا طبيعي. وفري بيئة آمنة ومحفزة للاستكشاف وتحدثي مع طفلك كثيراً واقرئي له يومياً فالتفاعل اللغوي المبكر يعزز النمو العقلي واللغوي بشكل كبير. إذا لاحظتِ تأخراً ملحوظاً كعدم الجلوس في الشهر التاسع أو عدم الاستجابة للأصوات فاستشيري طبيب الأطفال مبكراً.'},
    ],
  };
