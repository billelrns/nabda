...
### 87. تطوير قاعدة بيانات أسماء المواليد (2000 اسم عربي وإسلامي)

تم إحداث قفزة نوعية في قاعدة بيانات أسماء المواليد داخل التطبيق لتبلغ **2000 اسم فريد** (1000 اسم ولد و1000 اسم بنت) مصنفة جغرافياً ولغوياً:
- **سكريبت توليد الأسماء (`generate_baby_names.py`)**: سكريبت بايثون مخصص لتوليد 2000 اسم فريد مع معانيها الدقيقة، وتصنيفها الجغرافي حسب انتشارها في الدول العربية، وتحديد الأسماء القرآنية/الإسلامية.
- **إعادة هيكلة كود الواجهة**: إزالة أزيد من 300 سطر من الأسماء الصلبة في `baby_names_screen.dart` واستبدالها بالاستيراد التلقائي من `baby_names_database.dart` لزيادة كفاءة التحميل والصيانة وتحسين أداء التطبيق.
...
## المرحلة 17: تدقيق أصول Higgsfield + بانر المتجر + خط رفع Firebase (جلسة 25-27 يوليو 2026 — Cowork)
...
- **أيقونة التطبيق الرسمية** (launcher) مبنية على شعار القلبين + `flutter_launcher_icons`.
- تشغيل `upload_images_to_firebase.js` على الجهاز المحلي ثم ربط الروابط بالمقالات.
